...
from ventas.models import CabeceraVenta
from ventas.forms import *


class todo_listCreateView(CreateView):
    model = CabeceraVenta
    template_name = 'ventas/todo_list_create.html'
...
def TodoitemAjax(request):
    if request.is_ajax():
        ...
        response = JsonResponse({'producto': autor.producto, 'cantidad': autor.cantidad})
